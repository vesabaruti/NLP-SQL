...
def queryGenerator(tagged, keywords, numerals, query):
    ...
    stopw = ['need', 'i', 'fetch', 'give', 'all', 'find', 'display', 'greater', 'less', 'more', 'than', 'list', 'show',
             'select', 'out', 'number', 'select', ',', 'get', 'retrieve', 'print', 'tell', 'having', 'whose',
             'details'] + stopwords.words('english')
